...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Where(a =>!a.Name.Contains("Adminstrators")).ToList() // الشرط دا ال مكتوب تحت علشان مخليش اختيار ادمن يظهر اثناء الريجستر وحد يختار نفسه ادمن وهو بيسجل
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // عملتها (static) .... بعدين خليتها daynamic
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.AddToRolesAsync(user.Id, model.UserType); // to add role to user by me
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            // 1- التأكد من الباسورد القديم ع انه سليم
